...
public class Org_webinos_android_app_wrt_mgr_Origin {

	private static Object[] __args = new Object[3];

	public static Object[] __getArgs() { return __args; }

	public static void __import(org.webinos.android.app.wrt.mgr.Origin ob, Object[] vals) {
		ob.host = (String)vals[0];
		ob.port = (int)((org.meshpoint.anode.js.JSValue)vals[1]).longValue;
		ob.scheme = (String)vals[2];
	}

	public static Object[] __export(org.webinos.android.app.wrt.mgr.Origin ob) {
		__args[0] = ob.host;

...
public class WidgetConfig {
	...
	public WidgetConfig(ContentResolver resolver, String installId) throws IOException {
		...
		InputStream is = null;
		try {
			config.load(is = resolver.openInputStream(Uri.parse("content://org.webinos.android.wrt/" + installId + "/.config")));
		} finally {
			if(is != null) is.close();
		}
		String startFile = config.getProperty("widget.startFile.path");
		startUrl = "content://org.webinos.android.wrt/" + installId + "/wgt/" + startFile;
	}

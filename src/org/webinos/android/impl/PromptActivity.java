...
public class PromptActivity extends Activity {
	...
	private static final String LABEL = "org.webinos.android.impl.PromptActivity";
	Context ctx;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			if(extras!=null) {
				message = extras.getString("org.webinos.android.impl.PromptImpl.message");
				choice = extras.getStringArray("org.webinos.android.impl.PromptImpl.choice");
			}
	...
	private void sendResult(int code) {
		...
		Intent intent = new Intent("org.webinos.android.impl.PromptImpl.PROMPT_RESPONSE");
